      ...
      <MDBContainer fluid className="text-center text-md-left">
        <MDBRow>
          <MDBCol md="2">
            ...
            <img className="footerLogo" alt="" src="/media/KrakenKodersFooter.png"></img>
            </div>
          </MDBCol>
          <MDBCol md="8">
          ...
          <MDBCol md="2">
            <h5 className="footerTitle">Connect With Us!{" "} </h5>
                ...
                <a className="myFooterLink" href="https://www.linkedin.com/company/kraken-koders/">{" "}<MDBIcon fab icon="linkedin" size="3x" /></a>
                <a className="myFooterLink" href="#!">{" "}<MDBIcon fab icon="twitter-square" size="3x" /></a>
                <a className="myFooterLink" href="#!">{" "}<MDBIcon fab icon="github-square" size="3x" /></a>
                </div>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
